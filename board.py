...
class Board(QFrame):  # base the board on a QFrame widget
    ...
    def initBoard(self):
        ...
        self.boardArray = [[0 for _ in range(self.boardWidth)] for _ in range(self.boardHeight)]  # TODO - create a 2d int/Piece array to store the state of the game
